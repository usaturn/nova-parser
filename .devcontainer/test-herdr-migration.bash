...
test_launch_and_guards() {
    ...
    printf '%s\n' '#!/bin/sh' \
        'printf "updater %s\\n" "$*" >> "$HERDR_TEST_LOG.upd"' \
        > "$test_home/bin/herdr-status-updater"
